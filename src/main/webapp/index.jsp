...
<body>
	...
	<div class="col-xl-8 col-lg-6 col-md-8 col-sm-10  mx-auto form p-4">
		...
		<div class="px-2">
			<form method="post" action="SignIn" class="justify-content-center">
				<div class="form-group">
					<input type="text" class="form-control" placeholder="USERNAME"
						name="userName" required> <small id="emailHelp"
						class="form-text text-primary">Your information is safe
						with us.</small>
				</div>
				<div class="form-group">
